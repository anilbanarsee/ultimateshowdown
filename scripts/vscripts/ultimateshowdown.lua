...
CAMERA_DISTANCE_OVERRIDE = 2200.0        -- How far out should we allow the camera to go?  1134 is the default in Dota
...
function GameMode:OnHeroInGame(hero)
	...
	local ability = hero:FindAbilityByName("speed_force")
	if ability then
